...
public static class QueueFactory
{
    public static void SendMessageToExchange(string exchangeName,
                                             ...
                                             object obj)
    {
        var channel = CreateBaseConsumer().EnsureQueue(queueName, exchangeName).EnsureQueue(queueName, exchangeName).Model;
    ...
    public static EventingBasicConsumer CreateBaseConsumer()
    {
        var factory = new ConnectionFactory() { HostName = SalesProtalConstants.RabbitMQHost };
    ...
    public static EventingBasicConsumer EnsureExchange(this EventingBasicConsumer consumer,
                                                       string exchangeName,
                                                       string exchangeType = SalesProtalConstants.DefaultExchangeType)
    {
